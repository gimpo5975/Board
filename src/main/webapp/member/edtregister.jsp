...
<div class="cotainer mb-5">
	<form name="edtregisterform" class="registerform"
		action="/board/MemUpdate" method="post">
		<div class="mb-3 mt-3">
			<div class="row">
				<label for="userid" class="col-md-2 form-label">아이디 :</label>
				<div class="col-md-5">
					<input type="text" class="form-control" id="userid"
						placeholder="아이디" name="userid" value="${dto.userid }" />
				</div>
				<div class="col-md-5">
		...
		<div class="mb-3 mt-3">
			<div class="row">
				<label for="reurserpass" class="form-label col-md-2">비밀번호 확인
					:</label>
				<div class="col-md-5">
					<input type="password" class="form-control" id="reuserpass"
						placeholder="비밀번호확인" name="reuserpass" />
				</div>
				<div class="col-md-5"></div>
			</div>
		</div>
			...
			<div class="row">
				...
				<div class="col-md-5">
					<input type="text" class="form-control" id="username"
						placeholder="이름" name="username" value="${dto.username }" />
				</div>
				<div class="col-md-5"></div>
			</div>
		</div>
			...
			<div class="row">
				...
				<div class="col-md-5">
					<button type="button" class="btn btn-primary"
						onclick="sPostcode();">우편번호 검색</button>
				</div>
				...
				<div class="col-md-9 mt-3 col-md-offset-1">
					<input type="text" name="detailaddr" id="detailaddr"
						class="form-control" placeholder="상세주소" value="${dto.detailaddr}" />
				</div>
			</div>
		</div>
		...
		<div class="mb-3 mt-3">
			<div class="row">
				...
				<c:forTokens var="tels" items="${dto.tel}" delims="-" varStatus="n">
					<div class="col-md-3">
						<input type="number" class="form-control" id="tel${n.index+1 }"
							name="tel${n.index+1 }" value="${tels }" />
					</div>
				</c:forTokens>
			</div>
		</div>
